...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="fixed w-full top-0 z-[60] px-4 py-4 transition-all duration-300">
        <div className="container mx-auto">
          <div className="glass rounded-full px-6 py-3 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-6 font-medium text-[var(--text-secondary)]">
              <Link href="/products" className="hover:text-[var(--text-primary)] transition-colors relative group">
                Products
              ...
              <Link href="/login" className="bg-[var(--text-primary)] text-[var(--bg-primary)] px-5 py-2 rounded-full hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] transition-all duration-300">
                Login
              </Link>
            </div>
          </div>
